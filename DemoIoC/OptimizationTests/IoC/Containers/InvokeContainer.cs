...
namespace OptimizationTests.IoC.Containers
{
    ...
    {
        private readonly Dictionary<Type, InvokeRegisteredType> objectMap = new Dictionary<Type, InvokeRegisteredType>();
        ...
        public void Register<TResolved, TConcrete>(LifeCycle lifeCycle = LifeCycle.Transient)
        {
            ...
            lock (locker)
            {
                ...
                var registeredType = new InvokeRegisteredType(typeof(TConcrete), lifeCycle);
